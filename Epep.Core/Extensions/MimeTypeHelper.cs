namespace Epep.Core.Extensions
{
    public static class MimeTypeHelper
    {
        private static Dictionary<string, string> mimeTypes = new Dictionary<string, string>()
            {
                ...
                { ".pot", MIME_APPLICATION_VND_MSPOWERPOINT},
                { ".pps", MIME_APPLICATION_VND_MSPOWERPOINT},
                { ".ppa", MIME_APPLICATION_VND_MSPOWERPOINT },
                { ".pptx", MIME_APPLICATION_VND_PRESENT_PRESENT},
                { ".potx", MIME_APPLICATION_VND_PRESENT_TEMP},
                { ".ppsx", MIME_APPLICATION_VND_PRESENT_SLIDE},
                { ".ppam", MIME_APPLICATION_VND_MSPOWERPOINT_ADDIN},
                { ".pptm", MIME_APPLICATION_VND_MSPOWERPOINT_PRESENT},
                { ".potm", MIME_APPLICATION_VND_MSPOWERPOINT_PRESENT},
                { ".ppsm", MIME_APPLICATION_VND_MSPOWERPOINT_SLIDE},
                ...
                {".dot", MIME_APPLICATION_MSWORD},
                {".docx", MIME_APPLICATION_VND_WORD_DOC},
                {".dotx", MIME_APPLICATION_VND_WORD_TEMP},
                {".docm", MIME_APPLICATION_VND_MSWORD_DOC},
                {".dotm", MIME_APPLICATION_VND_MSWORD_TEMP},
                { ".xls", MIME_APPLICATION_VND_MSEXCEL },
                {".xlt", MIME_APPLICATION_VND_MSEXCEL},
                {".xla", MIME_APPLICATION_VND_MSEXCEL},
                {".xlsx", MIME_APPLICATION_VND_SPREADSHEET_SHEET},
                {".xltx", MIME_APPLICATION_VND_SPREADSHEET_TEMP},
                {".xlsm", MIME_APPLICATION_VND_MSEXCEL_SHEET},
                {".xltm", MIME_APPLICATION_VND_MSEXCEL_TEMP},
                {".xlam", MIME_APPLICATION_VND_MSEXCEL_ADDIN},
                {".xlsb", MIME_APPLICATION_VND_MSEXCEL_SHEET_BINARY},
                ...
                { ".p7s", MIME_APPLICATION_PKCS7 },
                {".cer",MIME_CERTIFICATE_CER },
                {".tsr",MIME_TIMESTAMP }
            };
        ...
        public const string MIME_APPLICATION_VND_WORD_DOC = "application/vnd.openxmlformats-officedocument.wordprocessingml.document";
        public const string MIME_APPLICATION_VND_WORD_TEMP = "application/vnd.openxmlformats-officedocument.wordprocessingml.template";
        public const string MIME_APPLICATION_VND_MSWORD_DOC = "application/vnd.ms-word.document.macroEnabled.12";
        public const string MIME_APPLICATION_VND_MSWORD_TEMP = "application/vnd.ms-word.template.macroEnabled.12";
        ...
        public const string MIME_APPLICATION_VND_SPREADSHEET_SHEET = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
        public const string MIME_APPLICATION_VND_SPREADSHEET_TEMP = "application/vnd.openxmlformats-officedocument.spreadsheetml.template";
        public const string MIME_APPLICATION_VND_MSEXCEL_SHEET = "application/vnd.ms-excel.sheet.macroEnabled.12";
        public const string MIME_APPLICATION_VND_MSEXCEL_TEMP = "application/vnd.ms-excel.template.macroEnabled.12";
        public const string MIME_APPLICATION_VND_MSEXCEL_ADDIN = "application/vnd.ms-excel.addin.macroEnabled.12";
        public const string MIME_APPLICATION_VND_MSEXCEL_SHEET_BINARY = "application/vnd.ms-excel.sheet.binary.macroEnabled.12";
        public const string MIME_APPLICATION_VND_MSPOWERPOINT = "application/vnd.ms-powerpoint";
        public const string MIME_APPLICATION_VND_PRESENT_PRESENT = "application/vnd.openxmlformats-officedocument.presentationml.presentation";
        public const string MIME_APPLICATION_VND_PRESENT_TEMP = "application/vnd.openxmlformats-officedocument.presentationml.template";
        public const string MIME_APPLICATION_VND_PRESENT_SLIDE = "application/vnd.openxmlformats-officedocument.presentationml.slideshow";
        public const string MIME_APPLICATION_VND_MSPOWERPOINT_ADDIN = "application/vnd.ms-powerpoint.addin.macroEnabled.12";
        public const string MIME_APPLICATION_VND_MSPOWERPOINT_PRESENT = "application/vnd.ms-powerpoint.presentation.macroEnabled.12";
        public const string MIME_APPLICATION_VND_MSPOWERPOINT_SLIDE = "application/vnd.ms-powerpoint.slideshow.macroEnabled.12";
        ...
        public const string MIME_APPLICATION_PKCS7 = "application/pkcs7-signature";
        ...
        public const string MIME_CERTIFICATE_CER = "application/x-x509-ca-cert";        
        ...
        public const string MIME_TIMESTAMP = "application/timestamp-reply";
    }
}
