...
namespace eCase.Web.Controllers
{
    public partial class AccountController
    {
        ...
        public class ViewsClass
        {
            ...
            public readonly string PasswordRecovery = "~/Views/Account/PasswordRecovery.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AccountController : eCase.Web.Controllers.AccountController
    {
        ...
        [NonAction]
        partial void LoginOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, eCase.Web.Models.Account.LoginVM vm, bool? captchaValid);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Login(eCase.Web.Models.Account.LoginVM vm, bool? captchaValid)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Login);
        ...
        [NonAction]
        partial void ForgotPasswordOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, eCase.Web.Models.Account.ForgotPasswordVM vm, bool? captchaValid);

        [NonAction]
        public override System.Web.Mvc.ActionResult ForgotPassword(eCase.Web.Models.Account.ForgotPasswordVM vm, bool? captchaValid)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.ForgotPassword);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "vm", vm);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "captchaValid", captchaValid);
        ...
        [NonAction]
        partial void PasswordRecoveryOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, eCase.Web.Models.Account.ActivateVM vm);

        [NonAction]
        public override System.Web.Mvc.ActionResult PasswordRecovery(eCase.Web.Models.Account.ActivateVM vm)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.PasswordRecovery);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "vm", vm);
        ...
        [NonAction]
        partial void ActivateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, eCase.Web.Models.Account.ActivateVM vm);

        [NonAction]
        public override System.Web.Mvc.ActionResult Activate(eCase.Web.Models.Account.ActivateVM vm)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Activate);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "vm", vm);
        ...
        [NonAction]
        partial void ChangePasswordOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, eCase.Web.Models.Account.ChangePasswordVM vm);

        [NonAction]
        public override System.Web.Mvc.ActionResult ChangePassword(eCase.Web.Models.Account.ChangePasswordVM vm)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.ChangePassword);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "vm", vm);
